...
<table class="table table-bordered table-striped">
	...
	<tbody>
		...
		<tr>
			<td><button type="button" class="btn btn-link-color">Link Color</button></td>
			<td>Link Color</td>
			<td><code>[pl_button type="link-color" link="" target="blank"]Link Color[/pl_button]</code></td>
		</tr>
		<tr>
			<td><button type="button" class="btn btn-link">Link</button></td>
			<td>Link Color that looks like a link (not a button)</td>
			<td><code>[pl_button type="link" link="" target="blank"]Link[/pl_button]</code></td>
		</tr>
		<tr>
			<td><button type="button" class="btn btn-page">Page</button></td>
			<td>Base color</td>
			<td><code>[pl_button type="page" link="" target="blank"]Page[/pl_button]</code></td>
		</tr>
		<tr>
			<td><button type="button" class="btn btn-overlay">Overlay</button></td>
			<td>Nearly transparent background that turns to Link Inverse color on hover</td>
			<td><code>[pl_button type="overlay" link="" target="blank"]Overlay[/pl_button]</code></td>
		</tr>
		<tr>
			<td><button type="button" class="btn btn-ol-white">Outline White</button></td>
			<td>White outline</td>
			<td><code>[pl_button type="ol-white" link="" target="blank"]Outline White[/pl_button]</code></td>
		</tr>
		<tr>
			<td><button type="button" class="btn btn-ol-black">Outline Black</button></td>
			<td>Black outline</td>
			<td><code>[pl_button type="ol-black" link="" target="blank"]Outline Black[/pl_button]</code></td>
		</tr>
		<tr>
			<td><button type="button" class="btn btn-ol-link">Outline Link</button></td>
			<td>Link color outline</td>
			<td><code>[pl_button type="ol-link" link="" target="blank"]Outline Link[/pl_button]</code></td>
		</tr>
	</tbody>
</table>
